          ...
          { 
                  data.results.map((starships) => {
                    ...
                    <Card style={styles.cardItem}>
                        ...
                        <Text style={styles.itemCost}> Cost { starships.cost_in_credits } credits</Text>
                        <Button mode="contained" onPress={() => console.log('Pressed')} style={styles.button}> <Text style={styles.itemButton}> Buy </Text> </Button>
                    </Card>
                   )
                  })
          }
